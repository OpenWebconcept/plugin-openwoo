...
class ElasticPress
{
    ...
    /**
     * @var \Yard\OpenWOO\Repository\OpenWOORepository
     */
    protected $repository;

    public function __construct(Config $config, OpenWOORepository $repository)
    {
        $this->config = $config;
    ...
    public function setFilters(): void
    {
        ...
        \add_filter('ep_indexable_post_types', [$this, 'removeOpenWOO'], 10, 1);
    }
    ...
    public function removeOpenWOO($postTypes): array
    {
        unset($postTypes['openwoo-item']);
